...
function HeroViewWork() {
  ...
  <Magnetic strength={0.3}>
            <a 
                href="#projects"
                className="group relative px-6 py-2 sm:px-6 sm:py-2  md:py-3 md:px-8 lg:py-4 lg:px-10 bg-transparent border border-primary/30 text-primary uppercase text-xs tracking-[0.2em] transition-all duration-500 
